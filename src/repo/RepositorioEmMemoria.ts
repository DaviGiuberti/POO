...
export class RepositorioEmMemoria<T extends { getID(): string }> implements IRepositorio<T> { // implementa a interface IRepositorio<T> para armazenar dados em memória
    private dados: T[] = [];
